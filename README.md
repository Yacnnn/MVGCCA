...
- Twitter Friend recommendation, available here : http://www.cs.jhu.edu/~mdredze/datasets/multiview_embeddings/
  ...
  Because of the size of the file, it is not provided on this repository. Hence, you have to download user_6views_tfidf_pcaEmbeddings_userTweets+networks.tsv.gz (1.4 GB) file. Extract it. Then concatenate file _uidPerFriend_test_all.txt, _uidPerFriend_dev_all.txt to _uidPerFriend_fuse_all.txt. And concatenate _uidPerHashtag_test_all.txt, _uidPerHashtag_dev_all.txt to _uidPerHashtag_fuse_all.txt.
