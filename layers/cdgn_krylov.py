...
class Cdgn_Krylov(tf.keras.Model):
    def __init__(self,
                 output_dim = 3,
                 num_of_layer = 3,
        ...
        super(Cdgn_Krylov,self).__init__()
        #Parameters
    ...
    def build(self, input_shape):
        ...
        self.mean = tf.keras.layers.Dense(self.output_dim, activation = None, kernel_initializer = "zeros", name = "cdgn_phi_kryl")
    ...
    def call(self,inputs):       
        ...
        return self.mean(layers_output), self.logvar(layers_output)