...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_layer', type = int, default= 1024, help='Size of hidden layers for encoders AND decoders.')
    ...
    parser.add_argument('--write_latent_space', type = str2bool, default = True, help='True or False. Decide whether or not to write latent space.')
